package com.tinyrpc.core.client;

import com.tinyrpc.core.client.handler.ClientInitializer;
...
public class RpcClient {
    ...
    public RpcClient(String serverHost, Integer serverPort) {
        this.serverHost = serverHost;
        this.serverPort = serverPort;
    }
    public RpcClient(Integer serverPort) {
        this(DEFAULT_HOST, serverPort);
    }
